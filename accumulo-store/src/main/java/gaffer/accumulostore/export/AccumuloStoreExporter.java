...
public class AccumuloStoreExporter extends GafferExporter {
    ...
    public String getTableNamePrefix() {
        return getStoreProperties().getTable() + SEPARATOR + getExportName();
    }
    ...
    @Override
    protected AccumuloProperties createExportStoreProps() {
        final AccumuloProperties props = getStoreProperties().clone();
        props.setTable(getTableName());
        return props;
    }
    ...
    private String getTableName() {
        final String tableName = getTableNamePrefix();
